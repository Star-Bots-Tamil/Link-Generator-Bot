...
links = []
@StreamBot.on_message(filters.private | filters.command("multi") & (filters.document | filters.video | filters.audio | filters.voice | filters.animation | filters.sticker | filters.photo | filters.video_note), group=4)
